...
//        return query.setParameter("id", id).setParameter("userId", userId).executeUpdate() != 0;
        int n = em.createNamedQuery(Meal.DELETE)
                .setParameter("id", id)
...
//                , Meal.class).getResultList();
        List<Meal> resultList = em.createNamedQuery(Meal.ALL_SORTED, Meal.class)
                .setParameter("userId", userId)
                .getResultList();
...
//                , Meal.class).getResultList();
        ...
        List<Meal> resultList = em.createNamedQuery(Meal.GET_BETWEEN, Meal.class)
                .setParameter("userId", userId)
