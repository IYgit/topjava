...
public class UserMealsUtil {
  public static void main(String[] args) {
    ...
    List<UserMealWithExceed> withExceeded = getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    withExceeded.forEach(System.out::println);
  }
  ...
  public static List<UserMealWithExceed> getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
    ...
    Stream<UserMealWithExceed> exceedStream = mealList.stream()
